...
const AllRooms = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg: flex-row items-start justify-between pt-28 md:pt-35 px-4 md: px-16 lg:px-24 x1:px-32">
        ...
        {roomsDummyData.map((room) => (
          ...
          >
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div>
                <img src={assets.locationIcon} alt="" className="inline mr-1" />
      ...
      {/* Filters */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-1g: mt-16">
        <div
          className={`flex items-center justify-between px-5 py-2.5
min-1g: border-b border-gray-300 ${openFilters && "border-b"}}`}
        >
