    ...
    <div className="mb-30 mt-20">
      ...
      <div className="mt-20 mb-20">
        <Title
          ...
          subtitle="Subscribe to our newsletter and be the first to know about our exclusive offers, new destinations, and travel tips. Stay connected with us for unforgettable travel experiences."
        />
      </div>
      <div className="max-w-5xl py-16 md:pl-20 md:w-full mx-2 md:mx-auto p-4 flex flex-col md:flex-row items-center justify-between text-left bg-gradient-to-b from-[#4C0083] to-[#180047] rounded-2xl md:p-10 text-white">
        ...
        <div className="flex items-center gap-2 bg-violet-900 max-md:mt-6 pl-4 h-11 text-sm rounded-full overflow-hidden">
          ...
          />
          <button className="px-6 h-10 mr-1 rounded-full border border-violet-600 bg-violet-800 flex items-center gap-2">
            <span>Subscribe</span>
            <img
